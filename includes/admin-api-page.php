...
function knittnet_render_api_admin_page() {
    ...
    <div class="mxch-admin-wrapper mxch-api-wrapper">
        ...
        <div class="mxch-mobile-menu">
            <div class="mxch-mobile-menu-header">
                <span class="mxch-mobile-menu-title"><?php esc_html_e('API Access', 'knittnet'); ?></span>
            ...
            <nav class="mxch-mobile-menu-nav">
                <div class="mxch-mobile-nav-section">
                    <div class="mxch-mobile-nav-section-title"><?php esc_html_e('REST API', 'knittnet'); ?></div>
        ...
        <aside class="mxch-sidebar">
            ...
            <nav class="mxch-sidebar-nav">
                <div class="mxch-nav-section">
                    <div class="mxch-nav-section-title"><?php esc_html_e('REST API', 'knittnet'); ?></div>
                    ...
                    <div class="mxch-nav-item" data-section="api-token">
                        <button class="mxch-nav-link active" data-target="api-token">
                            ...
                            <span class="mxch-nav-link-text"><?php esc_html_e('Token', 'knittnet'); ?></span>
                            <?php if ($token_set): ?>
                    ...
                    <div class="mxch-nav-item" data-section="api-endpoints">
                        <button class="mxch-nav-link" data-target="api-endpoints">
                            ...
                            <span class="mxch-nav-link-text"><?php esc_html_e('Endpoints', 'knittnet'); ?></span>
                        </button>
                    </div>
                    ...
                    <div class="mxch-nav-item" data-section="api-examples">
                        <button class="mxch-nav-link" data-target="api-examples">
                            ...
                            <span class="mxch-nav-link-text"><?php esc_html_e('Examples', 'knittnet'); ?></span>
                        </button>
                    </div>
                    ...
                    <div class="mxch-nav-item" data-section="api-privacy">
                        <button class="mxch-nav-link" data-target="api-privacy">
                            ...
                            <span class="mxch-nav-link-text"><?php esc_html_e('Privacy', 'knittnet'); ?></span>
                        </button>
                    </div>
                </div>
            </nav>
        ...
        <main class="mxch-content">
            ...
            <div id="api-token" class="mxch-section active">
                <div class="mxch-content-header">
                    <h1 class="mxch-content-title"><?php esc_html_e('REST API', 'knittnet'); ?></h1>
                    ...
                    <div class="mxch-card-body">
                        <?php if ($token_set): ?>
                            <div class="mxch-field">
                                <div class="mxch-field-label"><?php esc_html_e('Current token', 'knittnet'); ?></div>
            ...
            <div id="api-endpoints" class="mxch-section">
                <div class="mxch-content-header">
                    <h1 class="mxch-content-title"><?php esc_html_e('Endpoints', 'knittnet'); ?></h1>
                    <p class="mxch-content-subtitle"><?php esc_html_e('All endpoints live under the WordPress REST namespace knittnet/v1.', 'knittnet'); ?></p>
                </div>
                        ...
                        <table class="mxch-api-endpoints-table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><span class="mxch-api-auth mxch-api-auth-none"><?php esc_html_e('None', 'knittnet'); ?></span></td>
                                ...
                                <tr>
                                    ...
                                    <td><span class="mxch-api-auth mxch-api-auth-bearer"><?php esc_html_e('Bearer', 'knittnet'); ?></span></td>
            ...
            <div id="api-examples" class="mxch-section">
                <div class="mxch-content-header">
                    <h1 class="mxch-content-title"><?php esc_html_e('Examples', 'knittnet'); ?></h1>
                    <p class="mxch-content-subtitle"><?php esc_html_e('Drop-in cURL snippets — replace YOUR_TOKEN with the value from the Token tab.', 'knittnet'); ?></p>
                </div>

                <div class="mxch-card">
                    <div class="mxch-card-header">
                        <h3 class="mxch-card-title"><?php esc_html_e('Health check', 'knittnet'); ?></h3>
                        <span class="mxch-card-subtitle"><?php esc_html_e('No auth required', 'knittnet'); ?></span>
                    </div>
                    <div class="mxch-card-body">
                ...
                <div class="mxch-card">
                    <div class="mxch-card-header">
                        <h3 class="mxch-card-title"><?php esc_html_e('Find transcripts where the bot had no knowledge to ground answers', 'knittnet'); ?></h3>
                    </div>
                    <div class="mxch-card-body">
  ...
  "<?php echo esc_html($transcripts_u); ?>?role=user&amp;has_rag_context=no&amp;since=2026-05-01&amp;limit=50"</code></pre>
                ...
                <div class="mxch-card">
                    <div class="mxch-card-header">
                        <h3 class="mxch-card-title"><?php esc_html_e('Push a Q&A entry into the knowledge base', 'knittnet'); ?></h3>
                    </div>
                    <div class="mxch-card-body">
  ...
  "<?php echo esc_html($knowledge_url); ?>"</code></pre>
                ...
                <div class="mxch-card">
                    <div class="mxch-card-header">
                        <h3 class="mxch-card-title"><?php esc_html_e('Bulk-delete two chat sessions', 'knittnet'); ?></h3>
                    </div>
                    <div class="mxch-card-body">
  ...
  "<?php echo esc_html($transcripts_u); ?>"</code></pre>
            ...
            <div id="api-privacy" class="mxch-section">
                <div class="mxch-content-header">
                    <h1 class="mxch-content-title"><?php esc_html_e('Privacy & Safety', 'knittnet'); ?></h1>
                    <p class="mxch-content-subtitle"><?php esc_html_e('What the API exposes — and how to keep it safe.', 'knittnet'); ?></p>
                </div>
