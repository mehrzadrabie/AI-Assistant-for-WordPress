    ...
    <div class="mxch-admin-wrapper mxch-pro-wrapper">
        ...
        <div class="mxch-mobile-menu">
            <div class="mxch-mobile-menu-header">
                <span class="mxch-mobile-menu-title"><?php esc_html_e('Pro & Extensions', 'knittnet'); ?></span>
            ...
            <nav class="mxch-mobile-menu-nav">
                ...
                <div class="mxch-mobile-nav-section">
                    <div class="mxch-mobile-nav-section-title"><?php esc_html_e('License', 'knittnet'); ?></div>
                ...
                <div class="mxch-mobile-nav-section">
                    <div class="mxch-mobile-nav-section-title"><?php esc_html_e('Extensions', 'knittnet'); ?></div>
        ...
        <aside class="mxch-sidebar mxch-pro-sidebar">
            ...
            <nav class="mxch-sidebar-nav">
                ...
                <div class="mxch-nav-section mxch-license-section">
                    <div class="mxch-nav-section-title"><?php esc_html_e('License', 'knittnet'); ?></div>
                ...
                <div class="mxch-nav-section mxch-extensions-section">
                    ...
                    <div class="mxch-nav-item" data-section="overview">
                        <button class="mxch-nav-link active" data-target="overview">
                            ...
                            <span class="mxch-nav-link-text"><?php esc_html_e('Overview', 'knittnet'); ?></span>
                        </button>
                    </div>
                    ...
                    <div class="mxch-nav-item mxch-addon-item" data-section="addon-<?php echo esc_attr($slug); ?>">
                        <button class="mxch-nav-link mxch-addon-nav-link" data-target="addon-<?php echo esc_attr($slug); ?>">
                            <span class="mxch-addon-status-dot <?php echo esc_attr($status['status']); ?>"></span>
                            <span class="mxch-nav-link-text"><?php echo esc_html(!empty($addon['sidebar_title']) ? $addon['sidebar_title'] : str_replace('KnittNet ', '', $addon['title'])); ?></span>
                        </button>
                    </div>
                    <?php endforeach; ?>
                </div>
        ...
        <main class="mxch-content mxch-pro-content">
            ...
            <div id="overview" class="mxch-section active">
                <div class="mxch-content-header">
                    <h1 class="mxch-content-title"><?php esc_html_e('Pro & Extensions', 'knittnet'); ?></h1>
                    <p class="mxch-content-subtitle"><?php esc_html_e('Manage your license and extend KnittNet with powerful add-ons. All add-ons are available for download from the Downloads page in your KnittNet account.', 'knittnet'); ?></p>
                </div>
                ...
                <div class="mxch-card mxch-license-mgmt-card">
                    ...
                    <div class="mxch-card-body">
                        <?php if ($license_status === 'active'): ?>
                            ...
                            <div class="mxch-license-info-grid">
                                <div class="mxch-license-info-item">
                                    <span class="mxch-license-info-label"><?php esc_html_e('Domain', 'knittnet'); ?></span>
                                    <span class="mxch-license-info-value">
                                        <?php echo esc_html($current_domain); ?>
                                        <?php if ($is_domain_linked): ?>
                                            <span class="mxch-domain-linked"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg> <?php esc_html_e('Linked', 'knittnet'); ?></span>
                                        <?php else: ?>
                                            <button type="button" id="link-domain-button" class="mxch-link-domain-btn"><?php esc_html_e('Link Domain', 'knittnet'); ?></button>
                                            <span id="domain-link-status"></span>
                                        <?php endif; ?>
                                    </span>
                                </div>
                                <div class="mxch-license-info-item">
                                    <span class="mxch-license-info-label"><?php esc_html_e('Email', 'knittnet'); ?></span>
                                    <span class="mxch-license-info-value"><?php echo esc_html($license_email); ?></span>
                                </div>
                                <div class="mxch-license-info-item">
                                    <span class="mxch-license-info-label"><?php esc_html_e('License Key', 'knittnet'); ?></span>
                                    <span class="mxch-license-info-value">
                        ...
                        <?php else: ?>
                            <!-- Activation Form -->
                            <form id="knittnet-activation-form" class="mxch-activation-form">
                                <div class="mxch-form-row">
                                    <div class="mxch-field">
                                        <label class="mxch-field-label" for="knittnet_pro_email"><?php esc_html_e('Email Address', 'knittnet'); ?></label>
                                        <input type="email" id="knittnet_pro_email" name="knittnet_pro_email" value="<?php echo esc_attr(get_option('knittnet_pro_email')); ?>" class="mxch-input" required placeholder="your@email.com" />
                                    </div>
                                    <div class="mxch-field">
                                        <label class="mxch-field-label" for="knittnet_activation_key"><?php esc_html_e('Activation Key', 'knittnet'); ?></label>
                                        <input type="text" id="knittnet_activation_key" name="knittnet_activation_key" value="<?php echo esc_attr(get_option('knittnet_activation_key')); ?>" class="mxch-input" required placeholder="XXXX-XXXX-XXXX-XXXX" />
                                    </div>
                                </div>
                                ...
                                <div class="mxch-form-actions">
                                    ...
                                    <div id="knittnet-activation-spinner" class="mxch-spinner" style="display: none;"></div>
                                </div>
                ...
                <div class="mxch-content-header mxch-mt-xl">
                    <h2 class="mxch-content-title mxch-h2"><?php esc_html_e('Available Extensions', 'knittnet'); ?></h2>
                    <p class="mxch-content-subtitle"><?php esc_html_e('Click on any extension to learn more and get started.', 'knittnet'); ?></p>
                </div>
                    ...
                    <div class="mxch-addon-hero-content">
                        ...
                        <div class="mxch-addon-hero-actions">
                            ...
                            <?php else: ?>
                                ...
                                <a href="https://knittnet.ai/" target="_blank" class="mxch-btn mxch-btn-primary mxch-btn-lg">
